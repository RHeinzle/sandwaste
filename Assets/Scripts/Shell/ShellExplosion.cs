...
public class ShellExplosion : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        for (int i = 0; i < colliders.Length; i++)
        {
            ...
            float damange = CalculateDamage(target.position);
            targetHealth.TakeDamage(damange);
        }
        ...
        DestroyObject(m_ExplosionParticles.gameObject, m_ExplosionParticles.main.duration);
        Destroy(gameObject);
    }
